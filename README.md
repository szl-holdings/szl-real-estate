...
- Hugging Face Space (public, RUNNING — Hub readback 2026-08-30): [SZLHOLDINGS/terra-assurance](https://huggingface.co/spaces/SZLHOLDINGS/terra-assurance)
...
- Hub readback 2026-08-30: the Space is public and RUNNING (Docker SDK, cpu-basic). Automated CI push (`hf-space` workflow) is currently red — this README claims only what the Hub shows.
